...
defaults write com.appleo.print.PrintingPrefs "Quit When Finished" -bool true
...
# Set a blazingly fast keyboard repeat rate. Zoomies.
...
# Use list view in all Finder windows by default. Very important.
...
# Setup Dock apps the way i likes them
defaults write com.apple.dock persistent-apps -array \
